...
const KITS = {
  // ========== FIGHTER KITS ==========
  //
  // BENEFITS AND HINDRANCES ARE SUMMARISED, NOT TRANSCRIBED. Every number,
  // trigger and consequence is kept; the book's wording is not reproduced.
  //
  // These fourteen PHBR1 kits carried NO benefits or hindrances at all until
  // August 2026 -- the only kits in this file missing them -- because PHBR1 was
  // audited before that vocabulary settled and its Special Benefits and Special
  // Hindrances sections went untranscribed. The gap surfaced only when a
  // renderer was finally built for those fields and the fighter kits lit up
  // empty.
  //
  // A FIRST PASS TRANSCRIBED THEM NEAR-VERBATIM and was rewritten on Chris's
  // call. Two reasons, and both matter. Reproducing 3,000 characters of a
  // rulebook's prose per kit is not fan use. And it broke this file's own house
  // style: the fighter kits averaged four times the length of any other class
  // and fifteen times the paladin and bard entries, which are terse and
  // mechanical. Keep new entries in line with the shorter classes.
  fighter: {
    ...
    amazon: {
      ...
      benefits:
        "Male warriors in a civilization where female warriors are rare tend to underestimate the Amazon. In any fight where she confronts a male who is not familiar with her personally or with female warriors in general, she gets +3 to hit and +3 damage ON HER FIRST BLOW ONLY, because the opponent's guard is down. It does not work on player characters unless the player is role-playing honestly enough to declare that he too would underestimate her. An NPC wary enough not to underestimate her may, with a successful Intelligence check, see the attack coming and deny her the bonus. A seasoned veteran -- any Warrior of 5th level or higher, or any other character of 8th level or higher -- will realise she is moving like a trained warrior and keep his guard up. If she HITS an NPC with this attack he will never again be prey to it, and an NPC who merely SEES an Amazon hit someone with it will never fall for it himself; but if she misses the first strike, the target continues to underestimate her and she can use the bonuses again on her next strike. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "The Amazon suffers a -3 reaction roll adjustment from NPCs who are from male-dominated societies. This adjustment goes away for characters who come to respect her, such as her player-character allies. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "+3 to hit and +3 damage on her FIRST BLOW ONLY against a male opponent unfamiliar with her or with female warriors generally, because his guard is down. Does not apply to opponents of 5th level or higher (8th for non-warriors), to an NPC who makes a successful Intelligence check, or to player characters unless the player role-plays the assumption. Once she HITS an opponent, or any NPC sees her land the blow, that character is never fooled again; a miss does not burn it. (PHBR1, summarised.)",
      hindrances:
        "-3 reaction from NPCs of male-dominated societies. The penalty lapses for characters who come to respect her. (PHBR1, summarised.)",
      wealth:
    ...
    barbarian: {
      ...
      benefits:
        "Barbarians are impressive because of sheer strength, intensity and animal magnetism; this gives them a +3 reaction adjustment bonus in certain situations. Whenever the barbarian achieves a reaction roll of 8 or less (including Charisma and racial bonuses), subtract the modifier -- that is, if the reaction is positive at all, it will be even more positive than it otherwise would have been. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "All that impressiveness can work against the Barbarian too. Whenever he achieves a reaction roll of 14 or more, he takes an ADDITIONAL -3 modifier: if the reaction is negative at all, it will be even more negative than it otherwise would have been. The barbarian is scary, and the other person overreacts. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "+3 reaction adjustment whenever the encounter roll is 8 or less -- strength, intensity and animal magnetism making a good reaction better. (PHBR1, summarised.)",
      hindrances:
        "The same presence backfires: an ADDITIONAL -3 whenever the encounter roll is 14 or more. A reaction that was going badly goes worse, because he is frightening and people overreact. (PHBR1, summarised.)",
      wealth:
    ...
    beastrider: {
      ...
      benefits:
        "The Beast-Rider has an amazing rapport with one type of animal, which must be a species normally strong enough to carry him and act as a mount. He gets a +5 POSITIVE REACTION ADJUSTMENT whenever dealing with these animals; he finds it easy to make friends with them, and on a die-roll result of 9 or less on the Hostile column of the Encounter Reactions Chart he can even persuade attacking animals of this sort to leave him and his allies alone. Additionally he begins play with one of these animals as his personal friend and mount. That animal is devoted to him and will risk or even sacrifice its own life to save him, and the character is expected to behave the same way toward his mount. HE ALSO HAS A TELEPATHIC RAPPORT with his animal: in contact or visual sight he can tell what the beast is feeling and, if it has some intelligence, communicate with it without appearing to. When the two are not within line of sight, each still knows the other's emotional state, whether the other is hurt, and the direction and approximate distance to travel to find his friend. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "The Beast-Rider is out of place in most societies and takes a -3 negative reaction adjustment when meeting NPCs from any culture but his own; player-characters do not have to be hostile to him if they do not wish. SHOULD HIS ANIMAL EVER DIE, whether it is in his presence or far away, he immediately takes 2d6 points of damage and must make a saving throw vs. spells. If he fails, he behaves as if he were a magic-user hit with feeblemind for the next 2d6 hours. Even if he makes the saving throw, the player should role-play the character's reactions -- he has just felt, through their telepathic link, the death of his beloved friend. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "+5 reaction with his chosen animal species; on a Hostile-column result of 9 or less he can persuade attacking animals of that type to leave him and his allies alone. Begins play with one such animal free, devoted enough to risk its life for him. Shares a telepathic rapport with it: in sight or contact he knows what it feels and can communicate silently; out of sight each still knows the other's mood, injury, direction and rough distance. (PHBR1, summarised.)",
      hindrances:
        "-3 reaction from NPCs of any culture but his own. IF HIS ANIMAL DIES, wherever it is, he immediately takes 2d6 damage and must save vs. spells or behave as though feebleminded for 2d6 hours. (PHBR1, summarised.)",
      wealth:
    ...
    berserker: {
      ...
      benefits:
        "Berserkers receive a +3 reaction adjustment bonus from NPCs belonging to any tribe that also has Berserkers -- they recognise the Berserker instinctively and even fear him. THE OTHER BENEFIT IS HIS BERSERK. At any time he may choose to Go Berserk. This is not instantaneous: he must spend a full turn (ten combat rounds) to psych himself up, growling, moaning and uttering imprecations, and he may be fighting during that time. If he knows a fight is coming he can begin before it starts. If there is no enemy in sight yet he can hold the Berserk until combat is engaged, but if no combat takes place within five more full turns he automatically reverts to normal and suffers the ordinary consequences of coming out of a Berserk. He can come out of it once the last enemy is down (literally down on the ground, even if still alive and surrendering); the Berserker will stay berserk and continue fighting so long as there are enemies still on their feet. WHILE BERSERK he has phenomenal endurance and resistance to pain and some forms of magic: (1) immune, no saving throw necessary, to charm person, friends, hypnotism, sleep, irritation, ray of enfeeblement, scare, geas, and the clerical command, charm person or mammal, enthrall, cloak of bravery and symbol; (2) +4 to save against blindness, Tasha's uncontrollable hideous laughter, hold person, charm monster and confusion, and the clerical hold person and hold animal; (3) the emotion spell has no effect unless the caster chose fear, in which case he gets a normal saving throw -- if he makes it he continues as before, if he fails he is prematurely snapped out of his Berserk with all the normal effects but suffers no other fear effect. The fear spell has exactly the same effect. If he fails a saving throw against charm monster he simply counts the caster as one of his allies; he does not come out of the Berserk or obey the caster's commands. (4) Being Berserk offers no real protection from finger of death, except that the spell effects do not take place until he has come out of his Berserk: he does not suffer the 2d8+1 damage until immediately after he snaps out of it, and if he fails to save he does not die until he snaps out. (5) While Berserk he is immune to KO results from the Punching and Wrestling rules, and takes only half damage from bare-handed attacks from those rules. (6) While Berserk he gets +1 to attack, +3 to damage, and +5 hp. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "The Berserker has hindrances as severe as all those benefits. (1) He receives a -3 reaction from all NPCs except characters from tribes which have berserkers in them. (2) WHEN HE GOES BERSERK THE DM TAKES OVER HIS HIT POINTS. The DM asks how many hit points he currently has, and from that point until the fight is done and he has returned to normal the DM keeps track. The player is not told how many hp he has left, nor how much damage he is taking with each attack -- the character can feel no pain, so he cannot keep track of how close he is to death. The DM simply narrates: “The orc-captain hits you with his axe, a mighty blow which you barely feel...” It is therefore very possible for a Berserker to be nickled and dimed to death and not know it until he drops dead. The DM can also, if he chooses, roll all Saving Throws for the Berserker, not telling the player whether they were failures or successes. (3) While Berserk he can use NO RANGED WEAPONS. He kills only in hand-to-hand or melee-weapon combat. (4) While Berserk he must fight each opponent until that opponent is down. Once an opponent is felled he must move to the nearest enemy and attack him. He cannot, for instance, choose to attack the enemy leader if that leader is behind seven ranks of spearmen. He must keep fighting until all enemies are down. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "+3 reaction from NPCs of any tribe that also has berserkers. May GO BERSERK at will, taking one full turn to work himself up; he can hold it before combat for up to five turns, then reverts. He comes out of it only when the last enemy is off his feet. While berserk: +1 to hit, +3 damage, +5 hp; immune with no save to charm person, friends, hypnotism, sleep, irritation, ray of enfeeblement, scare, geas, command, charm person or mammal, enthrall, cloak of bravery and symbol; +4 to save vs. blindness, Tasha's uncontrollable hideous laughter, hold person, charm monster, confusion and hold animal; emotion and fear only end the berserk on a failed save; a failed save vs. charm monster merely counts the caster as an ally; finger of death is delayed until he snaps out; immune to KO from Punching and Wrestling and takes half damage from bare-handed attacks. (PHBR1, summarised.)",
      hindrances:
        "-3 reaction from all NPCs except those from tribes with berserkers. WHILE BERSERK THE DM TRACKS HIS HIT POINTS IN SECRET -- the player is told neither his total nor the damage taken, since the character feels no pain, so he can be worn down and killed without warning; the DM may roll his saving throws unseen too. He may use no ranged weapons, and must fight each opponent until that opponent is down before moving to the NEAREST enemy -- he cannot choose his target. (PHBR1, summarised.)",
      wealth:
    ...
    cavalier: {
      ...
      benefits:
        "The Cavalier enjoys many special benefits. At 1st level he gets +1 to hit with any lance for which he has proficiency, when using the lance from horseback; this rises +1 every six experience levels (+2 at 7th, +3 at 13th). At 3rd level he gets +1 to hit with any ONE type of sword of his choice from among those he has proficiency with, rising +1 every six levels (+2 at 9th, +3 at 15th). At 5th level he gets +1 to hit with either horseman's mace, horseman's flail or horseman's pick, his choice from among those he has proficiency with, rising +1 every six levels (+2 at 11th, +3 at 17th). THESE PLUSES TO HIT DO NOT ADD TO DAMAGE, and do not allow the Cavalier to hit a monster that can only be hit by magical weapons. He is completely IMMUNE TO THE FEAR SPELL, and because he is so brave he inspires others to courage: he radiates an emotion spell in a 10-foot radius, radiating courage, but only to the extent that it negates fear -- it does not bestow the berserk fury the actual wizard spell provides. He is +4 TO SAVE against all magic which would affect his mind, such as charm person, friends, hypnotism, sleep, irritation, ray of enfeeblement, scare and geas, and the clerical command, charm person or mammal, enthrall, cloak of bravery and symbol. He STARTS PLAY WITH A HORSE he does not have to pay for -- Heavy, Medium or Light Warhorse, the player's choice subject to the DM's approval -- which is automatically a Charger. If that horse dies he must acquire another through the usual campaign means and will not be content with any horse that is not a Warhorse of Charger quality. And he has THE RIGHT TO DEMAND SHELTER from anyone in his own nation who is of status lower than nobility; most people of his own status or higher will be happy to offer him shelter when he is travelling. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "For all these benefits the Cavalier has some pretty hefty hindrances. HE CANNOT ATTACK AN OPPONENT AT RANGE: he must instead charge ahead and attack him in melee or jousting combat, so he cannot snipe with a bow or crossbow, cannot use a polearm from behind a shield wall, and has to be on the front line meeting his foes face-to-face. (He could shoot an opponent to stop him killing an innocent person; that is not a violation of his code. But he could not shoot the enemy to protect a friend if his friend is fighting that enemy honourably, even if his friend is losing.) In any combat HE MUST ATTACK THE BIGGEST AND MOST POWERFUL-LOOKING ENEMY; if held up by lesser troops he must dispatch them as quickly as possible and get to his “real” opponent. HE MUST ALWAYS HAVE THE HIGHEST-QUALITY ARMOR HE CAN AFFORD, constantly selling his old armor and buying the next most protective set as he gains money: full plate, then field plate, plate mail, bronze plate mail, banded or splint, chain, scale or brigandine, then ring or studded. Magic bonuses do not mean as much to him as the TYPE of armor -- he prefers a suit of ordinary field plate to a set of banded mail +5. HE MUST ALSO FOLLOW THE VERY STRICT CODE OF CHIVALRY: cheerfully perform any noble service or quest asked of him; defend to the death any person or item placed in his charge; show courage and enterprise when obeying his rulers; show respect for all peers and equals; honor all those above his station; demand respect and obedience from those below his station; scorn those who are lowly and ignoble (he will not help the ill-mannered, the coarse, the crude; he will not use equipment which is badly-made or inferior; he will fight on foot before riding a nag); perform military service to his lord whenever asked; show courtesy to all ladies (if male); regard war as the flowering of chivalry and a noble enterprise; regard battle as the test of manhood and combat as glory; achieve personal glory in battle; slay all those who oppose his cause; and choose death before dishonor. IF HE BREAKS HIS VOWS the first time, the DM warns the player that the Cavalier feels bad about violating his code. THE SECOND TIME he loses ALL his special benefits until he repents and undertakes a dangerous task to redeem himself, behaving according to his code and hindrances throughout; only when the task is successfully accomplished does he regain his benefits. IF HE BREAKS HIS VOW A THIRD TIME without repenting and undertaking that task, he has ABANDONED the Cavalier Warrior Kit: he permanently loses all the special benefits, no longer has to obey his knightly code, and receives a permanent -3 reaction adjustment from all members of his own culture, even those who do not know of his past. His horse, even if it is not the one he began play with, leaves him -- either riding off into the sunset without him, or attacking him. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "+1 to hit with any lance he is proficient in when mounted, from 1st level, rising +1 every six levels. The same for one chosen sword type from 3rd level, and one chosen horseman's weapon (mace, flail or pick) from 5th. These do not add to damage and do not let him hit creatures struck only by magical weapons. Immune to fear, and radiates courage in a 10-foot radius that negates fear without granting berserk fury. +4 to save against mind-affecting magic. Starts with a free warhorse of Charger quality, the type his choice subject to the DM. May demand shelter from anyone of lower status in his own nation. (PHBR1, summarised.)",
      hindrances:
        "May not attack at range -- he must close and fight in melee or joust, so no bows, crossbows or polearms from behind a shield wall. Must engage the biggest and most powerful-looking enemy, clearing lesser troops as fast as he can to reach him. Must always wear the best armor he can afford, upgrading as money allows and preferring type over magical bonus. Bound by a strict Code of Chivalry. BREAKING IT ESCALATES: the first time the DM warns him; the second he loses ALL special benefits until he repents and completes a dangerous redeeming task; the third, without repentance, he has ABANDONED THE KIT -- benefits gone permanently, a lasting -3 reaction from his own culture even from those ignorant of his past, and his horse leaves or turns on him. (PHBR1, summarised.)",
      wealth:
    ...
    gladiator: {
      ...
      benefits:
        "Gladiators, because of their intensive training, get a FREE WEAPON SPECIALIZATION. This does not cost any of their beginning weapon proficiencies: they still get all four of those, AND get this Specialization free. It must be chosen from bow (choice), cestus, dagger, drusus, lasso, net, scimitar, short sword, spear, trident and whip. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "Gladiators tend to be recognized -- as Gladiators, at least, if not by their own names -- wherever they go. This makes it more difficult for them to do things in secret; some troublesome NPC is always remembering “the tall, fair-haired gladiator” who was at the scene of the action, which makes it very easy for the authorities to follow the heroes' trail. The DM will have to enforce this scrupulously if the Gladiator is to have hindrances offsetting his benefits. Also, and this is strictly a role-playing consideration, PROMOTERS AND MANAGERS ARE ALWAYS INTERFERING in the Gladiator's life: trying to rush him to participate in certain-death events, to fight people the Gladiator does not want to fight, to force him to participate in events taking place at the exact time the Gladiator needs to be somewhere else. These promoters will go to any length to get their way; they may blackmail the character, kidnap his followers, use the time-honored bait of a gorgeous romantic interest (whom the Gladiator does not immediately realize is an employee of the promoter), and so forth. To make sure this is regarded as a hindrance, the DM should make it clear that these promoters are mostly of the sleazy variety who will cheat, rob and betray him at the drop of a hat. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "A free Weapon Specialization on top of his four normal beginning weapon proficiencies, chosen from bow, cestus, dagger, drusus, lasso, net, scimitar, short sword, spear, trident or whip. (PHBR1, summarised.)",
      hindrances:
        "Recognised as a gladiator wherever he goes, which makes acting in secret difficult and leaves a trail the authorities can follow. Promoters and managers constantly interfere -- pushing him into certain-death bouts, matches he does not want, and events timed to clash with his real business -- and will blackmail, kidnap his followers or plant a romantic interest to get their way. (PHBR1, summarised.)",
      wealth:
    ...
    myrmidon: {
      ...
      benefits:
        "The Myrmidon has two advantages of note. FIRST, he gets a FREE WEAPON SPECIALIZATION, which he must choose from battle axe, bow (composite long bow, composite short bow, or long bow), crossbow (heavy crossbow or light crossbow), lance (choice), polearm (choice), spear, or sword (choice). SECOND, the Myrmidon is usually in the employ of some powerful patron, and the DM decides what immediate benefits this grants him; they vary with the type of employer he is working for. For instance, if he is working for a wealthy nobleman he will not have to spend any money for room and board and will enjoy an upper-class existence; or, if he is part of a standing army, he may be immune to prosecution by the civilian authorities, though he can certainly face court martial for misdeeds. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "The Myrmidon is INSTANTLY RECOGNIZABLE by his military demeanor, erect posture, disciplined mannerisms and so on. (There are plenty of soldiers and mercenaries who are not Myrmidons who are not so distinctive.) Because he is distinctive he is easily remembered and described by witnesses to his adventures; this makes it easier for the enemy to identify him and follow his trail if he is trying to escape or travel through dangerous territory. A SECOND HINDRANCE IS HIS EMPLOYER, who naturally makes many demands on him. If the Myrmidon is a bodyguard he must accompany his employer just about everywhere, regardless of any personal goals or interests he has. If he is a common soldier he is subject to the orders of his officers. If he is a military officer he is subject to the orders of his superiors or the local ruler, and bears the added stress of having to look out for his men whenever they are engaged in military action. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "A free Weapon Specialization, chosen from battle axe, bow, crossbow, lance, polearm, spear or sword. Also enjoys whatever his patron provides -- board and an upper-class life under a wealthy noble, or immunity from civil prosecution in a standing army, at the DM's discretion. (PHBR1, summarised.)",
      hindrances:
        "Instantly recognisable by his military bearing, so he is easily described by witnesses and tracked by enemies. His employer makes constant demands: a bodyguard must accompany his employer everywhere regardless of his own goals, a soldier obeys his officers, and an officer answers to his superiors and carries the added burden of his men. (PHBR1, summarised.)",
      wealth:
        "Standard 5d4x10 gp starting gold.",
      races:
    ...
    noblewarrior: {
      ...
      benefits:
        "The Noble Warrior starts with more gold than other Warrior Kits (see Wealth Options). He receives a +3 REACTION from anyone of his own culture. WHEN TRAVELLING HE CAN DEMAND SHELTER from anyone in his own nation who is of lower social status than he; most people of his own status or higher will offer him shelter when he is travelling, up to two persons times the Noble Warrior's experience level (a 5th-level Noble Warrior's patron will offer shelter for him and up to nine of his companions). IN HIS OWN LAND he can administer low justice upon commoners -- acting as judge, jury and executioner for minor crimes he comes across. The definition of “minor crimes” is up to the DM, but in general should include assault, petty theft and the like. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "In order to become a Noble Warrior the character has SWORN AN OATH OF LOYALTY to some greater noble. If he is a squire to a knight he has an oath to his knight; if a knight himself, he is sworn to his king or some other noble, or perhaps to both. He is expected to live up to that oath from time to time: accompany his lord into combat, provide troops to his lord, even beggar his own household in order to support his lord's needs. ADDITIONALLY THE NOBLE WARRIOR IS EXPECTED TO LIVE WELL. After he is created he must add +10% TO THE BASE COST of goods, equipment and services he is buying -- FOR EACH EXPERIENCE LEVEL HE HAS -- to reflect his noble tastes and requirements. This extra cost is not just a tip; the character is buying higher-quality goods. If he is unable to spend this extra money because of lack of funds he can settle for lesser goods, but his bonus to Reaction rolls will be reduced at -1 per such incident, until it reaches +0, to reflect the fact that people are seeing that he is settling for shabbier goods and otherwise not living up to their expectations of how a noble warrior should live. At the DM's discretion other problems may follow: nobles fail to offer him shelter because he is such a shabby specimen, he gets a reputation as a penny-pincher, and so on. To retain his bonus, when the Noble Warrior is once again in the money he must do whatever it takes to upgrade his situation -- buy new clothes, go on a buying spree -- at the DM's discretion, and his +3 reaction will return. IF A NOBLE WARRIOR GETS A BAD REPUTATION, deservedly or undeservedly, his +3 reaction becomes a -6 reaction from everybody who knows of the reputation. And just as other nobles are expected to extend shelter to the Noble Warrior, he is expected to offer other nobles shelter when they are travelling through his territory, or when they meet on the road while he is encamped and they are not. Whenever a Noble Warrior character is getting too cocky, the DM can have him visited by a nice, large crowd of nobles to whom he is expected to offer shelter and food, and who proceed to eat him out of house and home. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "Starts with more gold than other warrior kits. +3 reaction from anyone of his own culture. May demand shelter from anyone of lower status in his own nation, for himself and up to two persons per experience level. In his own land he may administer low justice on commoners for minor crimes. (PHBR1, summarised.)",
      hindrances:
        "Sworn to a greater noble, and expected to honour that oath -- riding to war at his lord's side, providing troops, even beggaring his household to meet his lord's needs. Must live well: add +10% to the base cost of everything he buys, PER EXPERIENCE LEVEL, for higher-quality goods. If he cannot afford it he may settle for less, but his reaction bonus drops -1 per occasion until it reaches +0, and the DM may add further consequences; restoring his standing restores the bonus. A bad reputation, deserved or not, turns the +3 into a -6 from everyone who has heard it. He is also expected to shelter other nobles passing through, which can prove expensive. (PHBR1, summarised.)",
      wealth:
    ...
    peasanthero: {
      ...
      benefits:
        "No matter what he has done or what anyone thinks of him, the Peasant Hero ALWAYS HAS SHELTER and often has other help when he is in his own community. Unless it is known that he has hurt people from his own community, he will always find people to put him up, hide him and companions from the law, supply them with food and drink and what little weaponry can be scraped together (usually daggers), and even provide them with helpers -- earnest 0-level youths who want to grow up to be like their hero. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "Since the Peasant Hero is looked upon as a patron and hero by the people from his home, they will frequently come to him for help. Whenever the village is losing people to nocturnal predators, whenever a village overlord turns out to be a dangerous tyrant, whenever a local citizen is jailed and tried for something he did not do, the citizens turn to the Peasant Hero for help. AND IF HE TURNS THEM AWAY, he loses their respect and earns a -2 REACTION from all the peasants in the land until he is once again in his home community's good graces. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "Always has shelter in his home community, and usually more: people will hide him and his companions from the law, feed them, scrape together what weapons they can, and supply eager 0-level youths as helpers. Forfeit only if it is known he has harmed his own people. (PHBR1, summarised.)",
      hindrances:
        "His people bring him their troubles -- predators taking villagers, a tyrannical overlord, a neighbour jailed unjustly. TURNING THEM AWAY COSTS HIM A -2 REACTION FROM EVERY PEASANT IN THE LAND until he is back in his home community's good graces. (PHBR1, summarised.)",
      wealth:
    ...
    pirateoutlaw: {
      ...
      benefits:
        "Pirates and Outlaws do not have any intrinsic special benefits, although the DM can bestow some campaign-based benefits on them if he chooses. For instance, in many Pirate settings there is a powerful pirate city where the PCs can go to trade their ill-gotten gains, a place where the law dares not enter; this makes it easier for them to dispose of their goods and enjoy the benefits of a home city when otherwise they would not have one. As another example, in a “Merry Men” type outlaw campaign, the heroes have the dubious benefit of knowing that they are on the right side and that if they can just oust the current rulers -- probably restoring the proper rulers in the process -- they will have their fortunes restored or enhanced, the land will once again be bright and shiny, and everyone will live happily ever after. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "The major problem with being an outlaw or pirate is that THE LAW IS ALWAYS AFTER THE CHARACTERS. Though the authorities do not have to put in an appearance in every single play-session, they are always out there, plotting against the heroes. Many of them are quite clever, they probably have more money, ships and men than the heroes, and they will continue to plague the heroes until the campaign is done. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "No intrinsic special benefits. The DM may grant campaign-specific ones -- a lawless port where stolen goods can be sold and the law dares not follow, or the prospect of restored fortunes if the rightful ruler is put back on the throne. (PHBR1, summarised.)",
      hindrances:
        "The law is permanently after him. The authorities need not appear every session, but they are always working against him, are often clever, usually command more money, ships and men, and will keep coming until the campaign ends. (PHBR1, summarised.)",
      wealth:
    ...
    samurai: {
      ...
      benefits:
        "The samurai and ronin are able to FOCUS THEIR VITAL ENERGIES to increase their Strength score temporarily. Once per day per experience level, the samurai or ronin can increase his Strength to 18/00. This lasts for one full round, and must be preceded by a loud KIAI SHOUT (making it impossible for him to summon this strength silently or stealthily). For that one round, all his hit probability, damage adjustment, weight allowance, maximum press, open doors, and bend bars/lift gates rolls and functions are calculated as if his Strength were 18/00. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "The samurai and ronin have different special hindrances. THE SAMURAI is (supposed to be) absolutely devoted to his lord. He is expected instantly to obey every one of his lord's orders, up to and including killing himself or those he loves. If he refuses to obey an order he is dishonored and is expected to kill himself; if he does not, he becomes ronin. The DM should make sure the samurai is acutely aware of this by having his lord occasionally issue orders which are difficult for him to keep -- this does not always have to be “Kill all of your allies,” but the lord can issue orders which interfere with the samurai's personal goals and remind him that he is subservient to his lord. THE RONIN has his own great difficulty: HE EARNS EXPERIENCE POINTS AT HALF THE NORMAL RATE. When the DM awards the characters their experience, the ronin receives only half what he would if he were still a samurai. This hindrance goes away when the character once again swears allegiance to a lord and becomes a samurai -- at which point, of course, he is subject to the hindrances of the samurai. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "Once per day per experience level he may focus his energies to raise his Strength to 18/00 for ONE FULL ROUND, recalculating hit probability, damage, weight allowance, maximum press, open doors and bend bars accordingly. It must be preceded by a loud kiai shout, so it can never be done silently or by stealth. (PHBR1, summarised.)",
      hindrances:
        "A samurai owes absolute obedience to his lord, up to killing himself or those he loves. Refusing an order dishonours him and he is expected to take his own life; if he does not, he becomes ronin. The DM should test this with orders that are hard to obey. A RONIN EARNS EXPERIENCE AT HALF THE NORMAL RATE, and is freed of it only by swearing to a new lord -- at which point the samurai's own hindrances resume. (PHBR1, summarised.)",
      wealth:
    ...
    savage: {
      ...
      benefits:
        "One of the Savage's special benefits is that HE RECEIVES MORE BONUS NONWEAPON PROFICIENCIES than any other type of warrior, testimony to the fact that the Savage must know more skills just to stay alive. Another, substantial benefit is a SPECIAL ABILITY RESEMBLING A SPELL, which he may use ONCE PER DAY PER EXPERIENCE LEVEL (a 5th-level savage could use it five times per day). The ability must be chosen from the list below, must be chosen when the character is first created, and MAY NEVER BE CHANGED. It is not truly magic and detect magic will not detect it; it is an ability natural to the Savage, and does not require verbal, somatic or material components even if such are required from the normal spell. The list: (1) ALARM (Wizard 1st Level) -- only usable when he is resting or sleeping in a quiet place; it is not cast upon a particular place but alerts him to activity within 10 feet of where he lies, as if he were at the center of the 20-foot cube of effect of the actual spell. It merely alerts him to intrusion if he is already awake, or awakens him if he is asleep. (2) DETECT MAGIC (Wizard 1st Level) -- reflects the fact that the Savage is in tune with nature and can feel when there is something unnatural in the air. Unless the Savage is also a Ranger, he cannot determine the TYPE of magic present. (3) ANIMAL FRIENDSHIP (Priest 1st Level) -- can only make friends of an animal which is not angry or threatened. It can be used to make an angry or threatened animal calm; to make friends with an angry or threatened animal, therefore, the Savage must be able to use the ability twice that day (he must be of 2nd level or higher) and must have two uses left. To use the ability the Savage must confront the animal, face to face, at no further away than the limits of the animal's attack range. As with the spell, the Savage must actually have no ulterior motives, for such will be detected by the animal and the ability will fail. (4) DETECT EVIL (Priest 1st Level) -- like the Detect Magic ability above. Like the Priest spell, this Detect Evil cannot detect evil in a PC, only in a monster, place or magical item. The DM can disallow any of the four abilities, or introduce new ones, though he cannot add anything that resembles a magical spell above 1st level. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "The Savage has some drawbacks too. HE IS UNCOMFORTABLE IN CIVILIZED CLOTHES AND ARMOR. When wearing any sort of clothing more cumbersome and concealing than his normal tribal dress, he suffers a -1 TO ALL ATTACK, DAMAGE AND NONWEAPON PROFICIENCY ROLLS: he is uncomfortable, and it is affecting his actions and reactions. Likewise, he can wear any type of armor, but is SO uncomfortable in it that he will suffer a -3 TO ALL ATTACK, DAMAGE AND NONWEAPON PROFICIENCY ROLLS while wearing any sort of armor at all. If a player blatantly decides not to role-play his character's dislike of armor and simply wears armor continually, accepting that negative modifier, the DM should gradually increase the modifier: -3 in one play-session, -4 in the next, -5 in the next, and so on, with no limit. If the player asks why this is happening, the DM need merely reply that the character is growing more and more uncomfortable in his unnatural trappings and finding it harder and harder to concentrate on the job at hand. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "Receives more bonus nonweapon proficiencies than any other warrior. Also has one spell-like ability usable ONCE PER DAY PER EXPERIENCE LEVEL, chosen at creation and NEVER CHANGED, from: alarm (only while resting, alerting him to activity within 10 feet), detect magic (he senses the unnatural but cannot identify the school unless he is also a Ranger), animal friendship (only on an animal that is not angry or threatened -- calming an angry one first costs a second use, so he must be 2nd level or higher, and he must face it within its attack range with no ulterior motive), or detect evil (monsters, places and magical items only, never a player character). The ability is not magic and detect magic will not find it; it needs no components. The DM may disallow any of the four or add others of no higher than 1st level. (PHBR1, summarised.)",
      hindrances:
        "Deeply uncomfortable in civilised dress and armor. -1 to ALL attack, damage and nonweapon proficiency rolls while wearing clothing more cumbersome than his tribal dress, and -3 while wearing armor of any kind. A player who ignores the role-playing and simply wears armor constantly should see the DM raise the penalty steadily -- -3, then -4, then -5, with no ceiling. (PHBR1, summarised.)",
      wealth:
    ...
    swashbuckler: {
      ...
      benefits:
        "The Swashbuckler has three special benefits. FIRST, when using up his Nonweapon Proficiency slots, he does not have to devote double the normal number of slots when choosing ROGUE proficiencies. SECOND, when he is wearing light or no armor -- no armor, leather armor, or padded armor -- he receives a -2 BONUS TO HIS AC (that is, an AC of 7 would become a 5); he is so nimble that he is very hard to hit. THIRD, the Swashbuckler is such a romantic figure that he always receives a +2 ADJUSTMENT on his reaction roll from NPC members of the opposite sex. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "TROUBLE SEEKS OUT THE SWASHBUCKLER. This is something the DM will have to play very carefully if the Swashbuckler is to be as hindered as all the other Warrior Kits. When there is another Swashbuckler around, intent on proving that he is the best swordsman in the world, it is the PC Swashbuckler he settles upon and challenges. When a certain young lady is being pursued by the king's guards, who are intent on stopping her from revealing secrets in her possession, it is the Swashbuckler she stumbles across when fleeing. When a prince is too drunk to attend his own coronation, miraculously he looks just like the Swashbuckler. Life conspires to make things difficult for the Swashbuckler, and the DM should always throw just a little more good-natured bad luck at that Warrior Kit than at any other. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "Three benefits. Rogue nonweapon proficiencies cost him the normal slots rather than double. Wearing no armor, leather or padded, he gains a -2 bonus to Armor Class. And he receives a +2 reaction from NPC members of the opposite sex. (PHBR1, summarised.)",
      hindrances:
        "Trouble seeks him out, and the DM is meant to enforce this so he is as hindered as any other warrior kit. The rival swordsman picks him to challenge; the hunted young lady stumbles into him; he happens to be the double of the prince too drunk for his own coronation. He should receive a little more good-natured bad luck than any other kit. (PHBR1, summarised.)",
      wealth:
    ...
    wildernesswarrior: {
      ...
      benefits:
        "The Wilderness Warrior gets a SPECIAL BONUS OF +5 TO HIS SURVIVAL PROFICIENCY ROLL. This only applies to the Survival proficiency pertaining to environments like that of his origin; if he later takes a second Survival proficiency for another type of territory, the bonus does not count toward it. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      hindrances:
        "The Wilderness Warrior, in his early years, is occasionally HINDERED BY HIS UNFAMILIARITY WITH THE PLAYER-CHARACTERS' SOCIETY, but this is a role-playing consideration: the DM must occasionally enforce it until he believes the character is sufficiently familiar with the usual culture. Transcribed from PHBR1 page images, August 2026 -- the fourteen PHBR1 fighter kits were the only ones in this file carrying no benefits or hindrances at all, because PHBR1 was audited before that vocabulary settled.",
      benefits:
        "+5 to his Survival proficiency roll, but ONLY for the Survival proficiency covering terrain like that of his origin. A second Survival proficiency for different territory gains nothing. (PHBR1, summarised.)",
      hindrances:
        "In his early career he is hampered by unfamiliarity with the player characters' society. This is a role-playing matter the DM enforces occasionally, until the character is judged familiar enough with the prevailing culture. (PHBR1, summarised.)",
      wealth:
  ...
  mage: {
    ...
    militantwizard: {
      ...
      oppositionOverride: {
        ...
        note: "REPLACES PHB Table 22 FOR THIS KIT. USE THE TOKEN \"Greater Divination\", NOT \"Divination\": isOppositionSpell special-cases that exact string to mean divination of 5TH LEVEL OR HIGHER, and lesser divination stays open to every wizard. Three of these rows were first written as plain \"Divination\" and wrongly blocked identify and read magic. The school names here must match SPECIALIST_WIZARDS exactly. There is NO ILLUSIONIST ROW because illusion is a barred school -- but barred is advisory, so a Militant Wizard illusionist is buildable. Fall back to PHB Table 22 for him and let the kit-requirement advisory speak; do NOT invent a row.",
        abjurer:     ["Illusion/Phantasm", "Alteration", "Greater Divination"],
        conjurer:    ["Alteration", "Greater Divination", "Invocation/Evocation"],
        enchanter:   ["Invocation/Evocation", "Necromancy", "Greater Divination"],
