...
function makeArmorNode(data={}, onChange){
  ...
  el.innerHTML =
    ...
    '<div class="armor-details" style="display:none;">' +
      ...
      '<div class="phbr1-only" data-phbr1-band="armorQuality" style="display:flex;gap:8px;align-items:flex-end;margin-bottom:6px;">' +
...
function makeWeaponNode(data={}, onChange){
  ...
  el.innerHTML =
    ...
    '<div style="display:flex;flex-wrap:wrap;align-items:flex-start;gap:8px;margin-bottom:6px;">' +
      ...
      '<div class="phbr1-only" data-phbr1-band="weaponQuality" style="display:contents;">' +
