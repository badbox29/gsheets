  ...
  <div class="sheet-body">
      ...
      <main class="card">
        ...
        <section class="section">
          ...
          <div class="row mw-barred-row" style="display:none;margin-top:8px;">
            <div class="col" style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
              ...
              <select data-field="mw_barred_1" style="width:auto;flex:1 1 0;min-width:0;" title="1 = abjuration, 2 = conjuration/summoning, 3 = greater divination, 4 = enchantment/charm, 5 = illusion, 6 = invocation/evocation, 7 = necromancy, 8 = alteration. Your DM rolls; enter the result.">
              ...
              <select data-field="mw_barred_2" style="width:auto;flex:1 1 0;min-width:0;" title="Second roll.">
                <option value="">&mdash;</option>
                <option value="Abjuration">1 Abjuration</option>
                <option value="Conjuration/Summoning">2 Conjuration/Summoning</option>
                <option value="Greater Divination">3 Greater Divination</option>
              ...
              <select data-field="mw_barred_3" style="width:auto;flex:1 1 0;min-width:0;" title="Third roll.">
                <option value="">&mdash;</option>
                <option value="Abjuration">1 Abjuration</option>
                <option value="Conjuration/Summoning">2 Conjuration/Summoning</option>
                <option value="Greater Divination">3 Greater Divination</option>
          ...
          <div class="row" style="margin-top:8px">
            <div class="col">
              ...
              <div style="display:flex;align-items:center;gap:10px;">
                <select data-field="campaign_setting" style="flex:0 0 200px;max-width:200px;"></select>
          ...
          <div class="specialty-priest" style="display:none;margin-top:8px;padding:8px;background:rgba(0,0,0,0.1);border-radius:var(--radius);">
            ...
            <!-- CROSS-CHECKS. OUTSIDE THE COLLAPSIBLE, DELIBERATELY: the section
                 is collapsed on every load, and a warning nobody can see is not a
                 warning. It sits between the explanatory paragraph and the
                 expander so a configuration problem is visible on the Core tab
                 without opening anything.
                 Advisory only, and worded as the book's guidance rather than as
                 errors, because PHBR3 BREAKS ITS OWN GUIDELINES in its own
                 entries: Agriculture is Poor combat on a d8 (p.21 says d6), and
                 Arts has ten major spheres where p.22 allows seven.
            ...
            <div class="sp-checks" style="display:none;margin-bottom:8px;padding:6px 8px;border-radius:var(--radius);font-size:11px;line-height:1.45;border:1px solid var(--warning, #e0a34a);background:color-mix(in srgb, var(--accent) 8%, transparent);"></div>
		  ...
		  <div class="row" style="margin-top:8px;display:flex;gap:12px;align-items:flex-start;">
			...
			<div style="flex:1;min-width:0;">
			  <div class="save-pair">
				...
				<div class="inputs">
				  <input data-field="save5_mental" class="save-input" type="text" readonly title="Spell save adjusted for Wisdom Magical Defense Adj.&#10;&#10;Applies to magical spells that attack the mind: beguiling, charm, fear, hypnosis, illusions, possession, suggestion, and the like (PHB Ch.1, Wisdom). The list is open-ended and is not limited to any one school.">
        ...
        <section class="section">
          ...
          <!-- PHBR4 p.40, second limitation: he learns spells as if his
               ...
               one field. -->
          <div class="mw-int-banner" style="display:none;margin-bottom:10px;padding:8px;border-radius:var(--radius);font-size:12px;line-height:1.4;border:1px solid var(--warning, #e0a34a);background:color-mix(in srgb, var(--accent) 8%, transparent);"></div>
          <div class="row">
            <div class="col">
      ...
      <main class="card">
        ...
        <section class="section utility language-browser-section">
          <div style="display:flex;justify-content:space-between;align-items:center;">
            ...
            <button class="toggle-language-browser-visibility">Show/Hide</button>
          </div>
          ...
          <div class="language-browser-content" style="display:none;">
            ...
            <div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap;">
              ...
              <button class="refresh-languages">Refresh List</button>
            </div>
        ...
        <section class="section utility weapon-browser-section">
          <div style="display:flex;justify-content:space-between;align-items:center;">
            ...
            <button class="toggle-weapon-browser-visibility">Show/Hide</button>
          </div>
          <p style="font-size:12px;color:var(--muted);margin-bottom:12px;">
          ...
          <div class="weapon-browser-content" style="display:none;">
            ...
            <div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap;">
              ...
              <select class="weapon-group-filter" style="width:150px;">
                ...
                <!-- Options are generated by populateWeaponGroupFilter() from
                     WEAPON_GROUP_ORDER in tables.js. Do not hand-maintain a list here. -->
              </select>
              <button class="refresh-weapons">Refresh List</button>
            </div>
        ...
        <section class="section utility nwp-browser-section">
          <div style="display:flex;justify-content:space-between;align-items:center;gap:8px;">
            ...
            <button class="toggle-nwp-browser-visibility" style="flex-shrink:0;">Show/Hide</button>
          </div>
          <p style="font-size:12px;color:var(--muted);margin-bottom:12px;">
          ...
          <div class="nwp-browser-content" style="display:none;">
            ...
            <div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap;">
              ...
              <button class="refresh-nwp">Refresh List</button>
            </div>
    ...
    <div class="vtab-content" data-vtab="magic">
      <main class="card">
	    ...
	    <section class="section">
		  <div style="display:flex;justify-content:space-between;align-items:center;">
		    <h3>Spell Access</h3>
		    <button class="toggle-spell-access">Show/Hide</button>
		  </div>
		  <p style="font-size:12px;color:var(--muted);margin-bottom:12px;">
        ...
        <section class="section utility spell-browser-section" style="display:none;">
          <div style="display:flex;justify-content:space-between;align-items:center;">
            <h3>Spell Browser</h3>
            <button class="toggle-spell-browser-visibility">Show/Hide</button>
          </div>
          <p style="font-size:12px;color:var(--muted);margin-bottom:12px;">
		...
		<section class="section spellbook-section" style="display:none;">
		  <div class="section-group-head">
			...
			<span class="grp-rule"></span>
			<button class="toggle-spellbook-visibility">Show/Hide</button>
		  </div>
		  <p style="font-size:12px;color:var(--muted);margin-bottom:12px;">
		  ...
		  <div class="spellbook-content" style="display:block;">
			...
			<div class="mw-highlevel-banner" style="display:none;margin-bottom:10px;padding:8px;border-radius:var(--radius);font-size:12px;line-height:1.4;border:1px solid var(--warning, #e0a34a);background:color-mix(in srgb, var(--accent) 8%, transparent);"></div>
		...
		<section class="section utility equipment-browser-section">
		  <div style="display:flex;justify-content:space-between;align-items:center;">
			...
			<div style="display:flex;gap:6px;">
			  <button class="open-goods-modal">Price Reference</button>
			  <button class="toggle-equipment-browser-visibility">Show/Hide</button>
			</div>
		  </div>
		  <p style="font-size:12px;color:var(--muted);margin-bottom:12px;">
		  ...
		  <div class="equipment-browser-content" style="display:none;">
			...
			<div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap;">
			  ...
			  <button class="refresh-equipment">Refresh List</button>
			</div>
	  ...
	  <main class="card">
		...
		<section class="section utility weapon-inventory-browser-section">
		  <div style="display:flex;justify-content:space-between;align-items:center;">
			...
			<button class="toggle-weapon-inventory-browser-visibility">Show/Hide</button>
		  </div>
		  <p style="font-size:12px;color:var(--muted);margin-bottom:12px;">
		  ...
		  <div class="weapon-inventory-browser-content" style="display:none;">
			...
			<div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap;">
			  ...
			  <button class="refresh-weapon-inventory-browser">Refresh List</button>
			</div>
		...
		<section class="section utility ammunition-browser-section">
		  <div style="display:flex;justify-content:space-between;align-items:center;">
			...
			<button class="toggle-ammunition-browser-visibility">Show/Hide</button>
		  </div>
		  <p style="font-size:12px;color:var(--muted);margin-bottom:12px;">
		  ...
		  <div class="ammunition-browser-content" style="display:none;">
			...
			<div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap;">
			  ...
			  <button class="refresh-ammunition-browser">Refresh List</button>
			</div>
		...
		<section class="section utility armor-browser-section">
		  <div style="display:flex;justify-content:space-between;align-items:center;">
			...
			<button class="toggle-armor-browser-visibility">Show/Hide</button>
		  </div>
		  <p style="font-size:12px;color:var(--muted);margin-bottom:12px;">
		  ...
		  <div class="armor-browser-content" style="display:none;">
			...
			<div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap;">
			  ...
			  <button class="refresh-armor-browser">Refresh List</button>
			</div>
	...
	<div class="vtab-content" data-vtab="magic-items">
	  <main class="card">
		...
		<!-- MAGICAL ITEMS BROWSER. Lives on this tab because this is the tab it
		     mostly feeds, but it is the one browser that ROUTES ELSEWHERE: a
		     weapon lands on the Weapons tab and a worn item on the Armor tab,
		     with the Add button relabelled to say so. Ungated by design --
		     supplement content the books ADD takes no toggle. -->
		<section class="section utility magic-browser-section">
		  <div style="display:flex;justify-content:space-between;align-items:center;">
			<h3>Magical Items Browser</h3>
			<button class="toggle-magic-browser-visibility">Show/Hide</button>
		  </div>
		  <p style="font-size:12px;color:var(--muted);margin-bottom:12px;">
			Search and browse magical items from the supplement handbooks. Items are identified &mdash;
			weapons and worn items are added to their own tabs with the enchantment filled in.
		  </p>

		  <div class="magic-browser-content" style="display:none;">
			<div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap;">
			  <input class="magic-search" type="text" placeholder="Search magical items..." style="flex:1;min-width:200px;">
			  <select class="magic-group-filter" style="width:170px;">
				<option value="">All Kinds</option>
				<!-- Options generated by renderMagicBrowser from the displayGroup
				     values in core_magic.json. Do not hand-maintain a list here:
				     every new supplement can introduce a value. -->
			  </select>
			  <select class="magic-book-filter" style="width:150px;">
				<option value="">All Books</option>
				<!-- Generated the same way, from source.book. -->
			  </select>
			  <button class="refresh-magic">Refresh List</button>
			</div>

			<div class="magic-results" style="max-height:400px;overflow-y:auto;border:1px solid var(--border);border-radius:var(--radius);padding:8px;">
			  <p style="color:var(--muted);text-align:center;padding:20px;">Click Refresh List to load available magical items.</p>
			</div>
		  </div>
		</section>
      ...
      <main class="card">
		...
		<section class="section utility">
		  <div style="display:flex;justify-content:space-between;align-items:center;">
			...
			<button class="toggle-animals-browser-visibility">Show/Hide</button>
		  </div>
